...
Browser("Advantage Shopping").Page("Advantage Shopping").WebElement("HP Elite x2 1011 G1 Tablet").Click @@ hightlight id_;_Browser("Advantage Shopping").Page("Advantage Shopping").WebElement("HP Elite x2 1011 G1 Tablet")_;_script infofile_;_ZIP::ssf2.xml_;_
Browser("Advantage Shopping").Page("Advantage Shopping").WebEdit("quantity").Set DataTable("Quantity", dtGlobalSheet) @@ hightlight id_;_Browser("Advantage Shopping").Page("Advantage Shopping").WebEdit("quantity")_;_script infofile_;_ZIP::ssf3.xml_;_
...
Browser("Advantage Shopping").Page("Advantage Shopping").WebElement("NoItemsInCart").Highlight
Browser("Advantage Shopping").Page("Advantage Shopping").WebElement("Is this the Remove WebElement?").Click @@ hightlight id_;_Browser("Advantage Shopping").Page("Advantage Shopping").WebElement("WebElement")_;_script infofile_;_ZIP::ssf6.xml_;_
