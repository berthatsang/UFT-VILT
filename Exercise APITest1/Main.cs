/***************************************************************
    ...
    *  loss of information.
    *          
    *  To edit the test, open the file ‘Exercise APITest1.st’ 
    *  in HP Service Test.
     ***************************************************************/
...
@"<Envelope xmlns=""http://schemas.xmlsoap.org/soap/envelope/""><Body><GetFlights xmlns=""HP.SOAQ.SampleApp""><DepartureCity>Frankfurt</DepartureCity><ArrivalCity>Paris</ArrivalCity><FlightDate>2020-09-09T00:00:00-07:00</FlightDate></GetFlights></Body></Envelope>");
...
@"<Envelope xmlns=""http://schemas.xmlsoap.org/soap/envelope/"" xmlns:p1=""http://www.w3.org/2001/XMLSchema-instance""><Body><CreateFlightOrder xmlns=""HP.SOAQ.SampleApp""><FlightOrder><Class>Business</Class><CustomerName>Bertha Tsang</CustomerName><DepartureDate>2020-09-09T00:00:00-07:00</DepartureDate><FlightNumber>{Step.OutputProperties.StServiceCallActivity4.Body.GetFlightsResponse.GetFlightsResult.Flight[1].FlightNumber}</FlightNumber><NumberOfTickets>3</NumberOfTickets></FlightOrder></CreateFlightOrder></Body></Envelope>");
            ...
            VTDPropertyInfoBase pi7 = new VTDPropertyInfoBase("OutputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='GetFlightsResponse'][1]/*[local-name(.)='GetFlightsResult'][1]/*[local-name(.)='Flight'][1]/*[local-name(.)='FlightNumber'][1]");
